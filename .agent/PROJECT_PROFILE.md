...
- Maturity or current phase: M1 closed/frozen; M2 ENTRY-001 actuator qualified and ENTRY-002 temporal-navigation substrate audit complete as an exploration-substrate insufficiency result, with autonomous resource acquisition not established.
...
- M2 boundary: The opt-in A-funded actuator is qualified; ENTRY-002 found no existing endogenous exploration substrate and did not authorize a successor mechanism. Production remains V4/reserve OFF and PR #44 remains historical provenance.
