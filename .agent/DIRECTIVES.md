...
## D-20260815-dcdev001a-architecture-selection

- Issued: `2026-08-15T12:00:00-04:00`
- Issuer: User
- External directive: `DC-DEV-001A`
...
- Scope: Gate 0 governance carry-forward, source-level external landscape, bounded architecture selection, deterministic artifacts, and a future implementation contract.
- Exclusions: D-096 reopening, Gate 7, Gate 8, production organism changes, learning, memory, motor behavior, webcam/microphone processing, and evolution.
- Acceptance: Exact clean-base branch, separated governance manifests, source-level architecture decision, complete artifacts, validation, and draft PR.
- Risk class: NORMAL
- Relationship: new
- Related directive: none
- Status at issuance: ISSUED
...
- Issuer: User
- External directive: `DC-DEV-001A-R1`
- Objective: Close provenance, governance, validation, and first-slice contract defects without reopening architecture selection or modifying production organism biology.
- Scope: implementation-base provenance, first observer-coupled contract, governed dispositions, external licensing records, current state, and narrow exact-head workflow.
- Exclusions: DC-DEV-002 runtime, production chemistry, transport, mechanics, growth, fission, D-088, evolution-harness science, D-096 re-entry, learning, memory, selection, reproduction experiments, and external dependencies.
- Acceptance: Complete bounded package, exact remote validation, pushed branch, and architect re-review.
- Risk class: NORMAL
- Relationship: amends
...
## DC-M4-REPRODUCTIVE-ATTRACTOR-ARCHITECTURE-001 — completed bounded gate

- The observer-only architecture gate completed at `97f2e353312b0cf33ff4129670ac87b0dc7f1b09`, exact-head CI `34764877883 PASS`; artifact ZIP SHA256 is `c6908209d913bae5fb194f3b87111db76b9c03fc4b30d97884d87e3a4d7ca9cd`. The manifest is final and all 12 internal file hashes independently match.
- Current fission authority is `PASS`: simple parent and daughter guards, conservative partition, runtime/lifecycle validity, and exclusion of historical self-intersecting R19/R20 D-088 fissions are explicit. Historical D-088 reproduction is superseded, not deleted; current fixture-bound `7/10` is diagnostic only.
...
## DC-M4-R12 final governance-head seal and Notion readback

- Final governance head `d2cfeb3d69f5d28459a663d2295b1b1fc227a505` passed exact-head workflow `35059631812`. Final hosted artifact ZIP is `sha256:e049c58a0e608bf0fa36ccdf1a9b4f82f77108c31949fabd309f7331ecb55c41`; manifest `12/12`; binary `cec057e369ce03bff0720b35245372d53e86e59d0af9fadf7b3c57f1f45fda64`.
- Independent artifact/manifest/binary verification and a verifier rerun reproduce the accepted terminal `P_TO_M_STATE_NORMALIZED_R4_AND_R10_TRANSFER_QUALIFIED` (`30/30` R4 and `30/30` R10). The R12 directive page and canonical Digital Cell SOT have been updated and read back. No morphogenesis, reproduction, population, selection, reversal or final integration was executed; no successor started; PR #44 remains untouched.
