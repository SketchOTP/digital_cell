...
- `digital-protocell/crates/regulatory-core/` — accepted regulatory state, DC-DEV-003 remesh continuity, the single DC-DEV-004 local contractility adapter, DC-DEV-005 plasticity, the bounded DC-DEV-006 spatial contact adapter, DC-DEV-011 stick-slip, and the DC-DEV-012 endogenous polarity process.
...
- `digital-protocell/examples/dcdev012_gate_assay.rs` — fixed-topology 24-seed endogenous-polarity qualification; it configures the production process and collects evidence.
...
- `digital-protocell/experiments/generated/dcdev012/` — DC-DEV-012 compact stochastic polarity and matched-arm evidence artifacts.
