...
- 2026-07-26 | area:d094r2-selection | lesson:Neutral runs use no H/B label, so treatment frequency effects must subtract the treatment founder baseline before comparing neutral change; raw neutral-label subtraction is not the Gate 6 decision metric | evidence:docs/d094r2_selection_analysis.md
- D-095: D-094 checkpoints serialize generation but not individual age or parent IDs. Match causal replays on measured network phenotype (not clade label), exact generation/treatment/replicate, and nearest mass/reserve; synchronize pair exposure to the first fission-readiness boundary.
- 2026-07-27 D-095C: sealed H/B replay forcing is locally mechanistic (H: N/F pulse 2.75 for 100/400 steps then 0.264; B: constant 1.98 plus 0.08 structural/0.048 membrane damage per 350 steps). The first D-094 break is environment-phenotype specificity, while demographic dilution is secondary. A static finite processing-versus-repair allocation is sufficient for the next falsifiable contract; transport limitation and responsive regulation were not demonstrated as necessary.
- 2026-07-27 | area:d096-gate5 | lesson:The frozen finite catalytic simplex creates monotonic processing/repair expression and a B-amplified retained-material effect, but processing-heavy versus repair-heavy reserve change is exactly zero under both H and neutral pre-fission assays; stop at Gate 5 rather than increasing pressure or changing allocation | evidence:experiments/generated/d096/reciprocal_prefission/attempt_001/result.json
- 2026-07-27 | area:d097-reserve-dispatch | lesson:Extending MaterialMesh with a new equation identity requires explicit compatibility updates in every inherited physiology schema guard; D-096 activation ran, but reserve_metab_step and reserve-funded growth both failed closed because reserve_schema_load_ok ended at D-094 | evidence:experiments/generated/d097/causal_ledger/analysis.json
- 2026-08-13 | area:strategy | lesson:GitHub repository was empty before synchronization; local history, branches, and tags required a first complete push without force or history rewrite | evidence:docs/strategy/2026-08-13_prior_art_rebase.md
- 2026-08-13 | area:prior-art | lesson:External ALife systems confirm that ecology protocols, generation/replicate accounting, neutral controls, lineage records, and analysis boundaries are reusable methodology; material mesh, conserved boundary, physical fission, and causal heredity remain Digital Cell-owned | evidence:docs/strategy/external_audit/tier1_evolution_synthesis.md
- 2026-08-13 | area:gpu | lesson:Ribossome wgpu and ALIEN CUDA provide infrastructure patterns but their genome-built organisms are not portable world implementations; defer a thin wgpu backend until measured need and CPU/certifier parity | evidence:docs/strategy/external_audit/tier2_world_synthesis.md
- 2026-08-13 | area:harness | lesson:Generation and lineage must be first-class causal records outside organism biology; max_generation=0 is untestable rather than a selection verdict, and event ledgers must fail closed on ancestry corruption | evidence:crates/evolution-harness/src/events.rs,src/lineage.rs
- 2026-08-13 | area:toolchain | lesson:Atlas and local rustup both lack an active Rust toolchain; do not claim runtime verification or install arbitrary system tooling | evidence:DC-SR-003 Gate 0
- 2026-08-13 | area:harness | lesson:Cargo metadata can validate the isolated workspace/member and dependency direction without compiling; runtime test claims remain blocked when the standard-library target is missing | evidence:DC-SR-003 Gate 0 and local cargo +stable test
