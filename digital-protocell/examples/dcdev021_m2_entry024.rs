//! DC-DEV-021 M2 ENTRY-024: polarity-effector semantic-orientation feasibility audit.
//!
//! This is an isolated observer assay. It reconstructs the accepted ENTRY-023
//! daughter fields and compares the already-qualified direct local fraction
//! against its parameter-free complementary fraction. The complementary field
//! is an assay-only antagonistic proxy, not a literal RhoA implementation and
//! not a production mapping. It tests semantic orientation only: the direct
//! field is replayed for parity, while the complementary field is evaluated as
//! a bounded counterfactual through unchanged contractility and traction.
