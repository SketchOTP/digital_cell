//! DC-DEV-021 M2 ENTRY-025: live antagonistic inherited-polarity locomotion audit.
//!
//! This is an isolated assay. It reuses the accepted physical fission and
//! native-ring helpers, then advances inherited direct and complementary
//! polarity through the live post-fission causal order. It does not alter
//! production polarity, fission, mechanics, resource physics, or M1.
