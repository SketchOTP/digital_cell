...
def main():
    ...
    dump(root, "cross_bond_a_attribution.json", {"mass_eligible_count": len(mass_rows), "summary": compact_rows(mass_rows), "interpretation": "no cross-bond requirement is directly reached because no lawful pinch candidate forms"})
