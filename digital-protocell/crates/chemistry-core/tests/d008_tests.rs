...
fn in_memory_five_field_payload_rejected_for_membrane_metabolism() {
    ...
    snap.fields = match five.fields {
        ...
        SnapshotFields::SurfaceDensity(_) => panic!("expected five-field baseline"),
        SnapshotFields::NineFieldSurfaceDensity(_) => panic!("expected five-field baseline"),
        SnapshotFields::NineFieldSurfaceMaturation(_) => panic!("expected five-field baseline"),
    };
...
fn malformed_payload_lengths_return_err_without_panic() {
    ...
    match &mut snap.fields {
        ...
        SnapshotFields::SurfaceDensity(_) => panic!("expected seven-field snapshot"),
        SnapshotFields::NineFieldSurfaceDensity(_) => panic!("expected seven-field snapshot"),
        SnapshotFields::NineFieldSurfaceMaturation(_) => panic!("expected seven-field snapshot"),
    }
