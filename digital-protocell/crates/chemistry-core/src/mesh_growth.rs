...
//!
//! Growth activates only when local A production exceeds local maintenance demand.
//! No radius/area/perimeter/division state enters the flux.
...
/// Additive growth step: J_growth,i = y_g · J_A,surplus,i · h(ε_i).
/// Consumes A, adds unlabeled structural mass; rest length follows ℓ⁰=m/ρ_s.
pub fn growth_step(
